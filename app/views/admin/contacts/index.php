<style>
    ...
    .badge.unread { background: rgba(255, 0, 60, 0.1); color: #ff003c; border: 1px solid #ff003c; box-shadow: 0 0 10px rgba(255, 0, 60, 0.3); }
    .badge.read { background: rgba(255, 204, 0, 0.1); color: #ffcc00; border: 1px solid #ffcc00; box-shadow: 0 0 10px rgba(255, 204, 0, 0.3); }
    .badge.replied { background: rgba(0, 255, 136, 0.1); color: #00ff88; border: 1px solid #00ff88; box-shadow: 0 0 10px rgba(0, 255, 136, 0.3); }
    ...
    .btn-success { color: #00ff88; border: 1px solid #00ff88; }
    .btn-success:hover { background: #00ff88; color: #000; box-shadow: 0 0 15px #00ff88; }
    ...
    /* Modal Sci-Fi */
    .modal { display: none; position: fixed; z-index: 2000; left: 0; top: 0; width: 100%; height: 100%; background: rgba(3, 7, 18, 0.8); backdrop-filter: blur(5px); }
    ...
    .modal-header { display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px; border-bottom: 1px solid rgba(0,242,255,0.2); padding-bottom: 15px;}
    .modal-header h3 { font-family: 'Orbitron', sans-serif; color: #00f2ff; text-transform: uppercase; margin:0; text-shadow: 0 0 8px rgba(0,242,255,0.4);}
    .modal-header button { color: #ff003c; text-shadow: 0 0 5px #ff003c; transition: 0.3s; background: none; border: none; font-size: 28px; cursor: pointer; }
    .modal-header button:hover { transform: scale(1.2); }
    
    #modalBody p { color: #94a3b8; margin-bottom: 10px; }
    #modalBody strong { color: #00f2ff; font-family: 'Orbitron', sans-serif; letter-spacing: 1px; font-size: 12px; margin-right: 5px; }
    hr { border-color: rgba(0, 242, 255, 0.2); margin: 20px 0;}
                ...
                <tr>
                    ...
                    <td>
                        <span class="badge <?= $status ?>">
                            <?= ($status == 'unread') ? 'Chưa đọc' : (($status == 'read') ? 'Đã đọc' : 'Đã phản hồi') ?>
                        </span>
                    </td>
